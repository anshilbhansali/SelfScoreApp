...
public class DebitCard {
    ...
    private String name = "Anshil Bhansali";

    public DebitCard(){};

    public DebitCard(String name, String c1, String c2, String c3, String c4, int expm, int expy, int sec, String addr, String appt, String zip)
    {
        this.name = name;
        cardnum1 = c1;
        cardnum2 = c2;
