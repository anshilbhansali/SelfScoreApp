...
public class PayNowActivity extends AppCompatActivity {
    ...
    private void setUpSelectPay()
    {
        TextView select_pay_method = (TextView) findViewById(R.id.select_pay_method);
        TextView select_pay_method2 = (TextView) findViewById(R.id.payment_method2);
        ...
        Intent intent = getIntent();
        if(intent.hasExtra("METHOD_NAME"))
        {
            select_pay_method.setText((String)intent.getExtras().get("METHOD_NAME"));
            select_pay_method2.setText((String)intent.getExtras().get("METHOD_NAME"));
        }
    }
